package com.emulate.search.common;

public class Context {
    public static String  ContentPath="D://";
    public static String NoSuchFile="没找到你要的资源呢，亲！";
    public static String Success="幸不辱命！哈哈，快说我很厉害。";
